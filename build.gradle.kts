...
plugins {
    ...
    id("org.owasp.dependencycheck") version "12.1.0" // version 11+ causes build failures, see https://github.com/spring-projects/spring-boot/issues/42952#issuecomment-2506304372
}
